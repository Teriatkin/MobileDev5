package ua.kpi.comsys.IV8226.ui_fragments.pics;
...
import ua.kpi.comsys.IV8226.adapters.PicsAdapter;
import ua.kpi.comsys.IV8226.model.PicItem;
...
public class PicsFragment extends Fragment {
    ...
    private void refresh() {
        listView.setRequestedColumnWidth(Utils.dpToPx(this.getContext(), 116));
        adapter = new PicsAdapter(getContext(), items);
        listView.setAdapter(new AsymmetricGridViewAdapter(getContext(), listView, adapter));
